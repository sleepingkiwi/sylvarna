    ...
    fields: [
      {
        ...
        showDetails: true,
        required: true,
        hint: 'Minimum width of 1,920px recommended. Anything above 2,500px will be cropped to 2,500px. This image will be shown in multiple formats across the site.',
      },
      {
        label: 'Sub-Header',
        name: 'subHeader',
